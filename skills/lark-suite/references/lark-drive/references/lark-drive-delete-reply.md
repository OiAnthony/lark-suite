...
> **前置条件：** 先阅读 [`../../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) 了解认证、全局参数和权限处理。

删除某条回复。**高风险写操作**：真实执行需要按 [`../../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) 的高风险审批协议向用户确认后追加 `--yes`；删除不可恢复。
