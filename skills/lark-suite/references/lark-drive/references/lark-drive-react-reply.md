...
> **前置条件：** 先阅读 [`../../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) 了解认证、全局参数和权限处理。reaction 查询规则、语义联想与完整 `reaction_type` 枚举见跨切面专题 [`lark-drive-reactions.md`](lark-drive-reactions.md)。
